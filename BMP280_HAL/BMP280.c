...
//    if( bmp280.read_bytes == NULL )
//        return BMP280_ERROR_RW_Func;
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x88, sizeof(uint16_t), buffer_i2c, 2, 1000);
    ...
    if( status == BMP280_SUCCESS )
        ...
        return status;
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x8A, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x8C, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x8E, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x90, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x92, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x94, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x96, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x98, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x9A, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x9C, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0x9E, sizeof(uint16_t), buffer_i2c, 2, 1000);
...
//    if( bmp280.read_bytes == NULL )
//        return ret;
//    if( BMP280_SUCCESS == bmp280.read_bytes(bmp280.obj, bmp280.addr, 0xD0, sizeof(uint16_t), &ret,1, 1000) )
...
//    if( bmp280.read_bytes == NULL )
//        return BMP280_ERROR_RW_Func;
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0xFA, sizeof(uint16_t), buffer_i2c, 3, timeout);
...
//    status = bmp280.read_bytes(bmp280.obj, bmp280.addr, 0xF7, sizeof(uint16_t), buffer_i2c, 3, timeout);
...
//uint32_t BMP280_init(cyhal_i2c_t *obj, uint8_t addr, uint32_t (*readFunction)(cyhal_i2c_t*, uint16_t, uint16_t, uint16_t, uint8_t*, uint16_t, uint32_t), uint32_t (*writeFunction)(cyhal_i2c_t*,uint16_t, uint8_t*, uint8_t, uint32_t, bool))
uint32_t BMP280_init(cyhal_i2c_t *obj, uint16_t addr)
{
    uint32_t result = 0ul;
    bmp280.addr = addr;
    bmp280.obj  = obj;
//    bmp280.read_bytes   = cyhal_i2c_master_mem_read;
//    bmp280.write_bytes  = cyhal_i2c_master_write;
